            ...
            <Table responsive="sm">
                ...
                <tr>
                    <th onClick={sortNameHandler}>
                        {props.tableHeader}
                        { (submittedSearch.sort === "") ? <FontAwesomeIcon className="fontawesome-users" icon={(submittedSearch.order !== "asc") ? faChevronUp : faChevronDown}/> : "" }
                    </th>
                    <th onClick={sortContributionHandler}>
                        Contributions
                        { (submittedSearch.sort === "repositories") ? <FontAwesomeIcon className="fontawesome-users" icon={(submittedSearch.order !== "asc") ? faChevronUp : faChevronDown}/> : "" }
                    </th>
                </tr>
                </thead>
                <tbody>
