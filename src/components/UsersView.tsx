            ...
            <Table responsive="sm">
                ...
                <tr>
                    <th onClick={sortNameHandler}>
                        {props.tableHeader}
                        { (submittedSearch.sort === "") ? <FontAwesomeIcon style={{cursor:'pointer', marginLeft: '10px'}} icon={(submittedSearch.order !== "asc") ? faChevronUp : faChevronDown}/> : "" }
                    </th>
                    <th onClick={sortContributionHandler}>
                        Contributions
                        { (submittedSearch.sort === "repositories") ? <FontAwesomeIcon style={{cursor:'pointer', marginLeft: '10px'}} icon={(submittedSearch.order !== "asc") ? faChevronUp : faChevronDown}/> : "" }
                    </th>
                </tr>
                </thead>
                <tbody>
